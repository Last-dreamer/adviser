...
// in adviser/test/domain/usecase/advice_usecases_test.dart.
...
import 'package:adviser/data/datasources/advice_remote_datasource.dart' as _i2;
import 'package:adviser/data/repositories/advice_repo_impl.dart' as _i4;
import 'package:adviser/domain/entities/advise_enitity.dart' as _i7;
import 'package:adviser/domain/failures/failure.dart' as _i6;
...
class MockAdviceRepoImpl extends _i1.Mock implements _i4.AdviceRepoImpl {
  @override
  _i2.AdviceRemoteDataSource get source => (super.noSuchMethod(
  ...
  _i5.Future<_i3.Either<_i6.Failure, _i7.AdviceEntity>>
      getAdviseFromDataSource() => (super.noSuchMethod(
            Invocation.method(
              #getAdviseFromDataSource,
              [],
            ),
            returnValue:
